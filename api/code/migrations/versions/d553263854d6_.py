...
Revision ID: d553263854d6
Revises: 
Create Date: 2020-04-02 23:04:19.172921
...
def upgrade():
    ...
    sa.Column('image', sa.String(length=255), nullable=True),
    sa.Column('creation_date', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['store_id'], ['store.id'], name=op.f('fk_item_store_id_store')),
